...
class AINewsLetterAgents():
    def editor_agent(self):
        return Agent(
            role='Editor',
            goal='Oversee the creation of the Bangaldesh Newsletter',
    ...
    def news_fetcher_agent(self):
        return Agent(
            role='NewsFetcher',
            goal='Fetch the Bangladesh news stories for the day',
            backstory="""Bangladesh""",
    ...
    def news_analyzer_agent(self):
        return Agent(
            ...
            analyses of Bangladesh news stories, making them accessible and engaging for our audience.""",
            tools=[SearchTools.search_internet],
            verbose=True,
            allow_delegation=True,
        )
